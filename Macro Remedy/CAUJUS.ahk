...
#6::
    tlf()
    Send, {TAB 23}{Right}{TAB 2}PUESTO DE TRABAJO{TAB}Usuaria llama comentando que su equipo presenta lentitud, los programas no funcionan correctamente.{TAB}SOFTWARE{TAB 2} Se realiza bateria de prubeas y se reincia el equipo, se comprueba que funciona correctamente{TAB 2} - ^{enter}{Enter}
    Send, !a {Down 9}{Right}{Enter}{TAB 12}{Right 2}{TAB 5}{Enter 3}
